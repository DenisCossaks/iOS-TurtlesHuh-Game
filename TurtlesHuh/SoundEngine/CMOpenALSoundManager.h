...
- (void) playBackgroundMusic:(NSString *)file isLoop:(BOOL)_isLoop;	//file is the filename to play (from your main bundle)
- (void) playBackgroundMusic:(NSString *)file forcePlay:(BOOL)forcePlay isLoop:(BOOL)_isLoop; //if forcePlay is YES, iPod audio will be stopped.
- (void) stopBackgroundMusic;
- (void) pauseBackgroundMusic;
- (void) resumeBackgroundMusic;

- (void) playSoundWithID:(NSUInteger)soundID isLoop:(BOOL)_isLoop withPitch:(float)_pitch gain:(float)_gain;	//id is the index in the sound filename array
