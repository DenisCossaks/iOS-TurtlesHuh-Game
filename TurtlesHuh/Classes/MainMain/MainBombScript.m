...
@implementation MainBombScript

-(void) manage{
    //[self manageInvicinbleAni];
...
-(void) manageBombAni{
    ...
    for(int i = 0 ; i < bombingAniMax ; i++){
        ...
        if(bombingAniStruct[i]->isAni){
            ...
            printf("M2:%i %i %4.8f %4.8f\n",i, bombingAniStruct[i]->aniTimer,bombingAniStruct[i]->s_bigClouds[0].position.x, bombingAniStruct[i]->s_bigClouds[0].position.y );
...
-(void) manageInvicinbleAni{
   ...
   /* gameoverBombTimer++;
    ...
    static float fuckBombGameoverScale = 1.75;
